...
\\ &= 0.4096
\end{align}
At first we ll test all the 200 groups. \\
Number of tests initially(A) :
\begin{align*}
A = 200
\end{align*}
Out of these 200 tests,let the expected number of groups tested positive b \\
Calculating b :
\begin{align}
...
&\implies b &&= 0.4096 * 200 \\
&\implies b &&= 81.92
\end{align}
In all the groups tested positive, atleast one individual is covid positive, to find all the covid positive individuals, we will test all the 5 individuals of the positive groups seperately. \\
So expected number of new tests (B) :
\begin{align}
B &= 5 * b \\ &= 5 * 81.92 \\ &= 409.6
\end{align}
Total number of tests expected (T) :
\begin{align}
